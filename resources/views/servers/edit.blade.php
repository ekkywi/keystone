            ...
            <form action="{{ route("servers.update", $server) }}" method="POST">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2.5" name="description" rows="2">{{ old("description", $server->description) }}</textarea>
                    </div>
