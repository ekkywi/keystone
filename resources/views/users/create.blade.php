                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 text-sm px-4 py-3 shadow-sm transition-all placeholder:text-slate-300" 
                                   name="name" placeholder="e.g. John Doe" required type="text" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="col-span-1">
                            ...
                            <input class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 text-sm px-4 py-3 shadow-sm transition-all placeholder:text-slate-300" 
                                   name="email" placeholder="john@example.com" required type="email" value="{{ old('email') }}">
                            @error('email')
                                <p class="text-rose-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative">
                                <select class="w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 text-sm px-4 py-3 shadow-sm transition-all appearance-none bg-white cursor-pointer" name="role">
                                    <option value="developer">Developer (Manage Projects & Services)</option>
                                    <option value="quality_assurance">Quality Assurance (View & Test)</option>
                                    <option value="system_administrator">System Administrator (Full Access)</option>
                                </select>
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-slate-500">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                                </div>
                            </div>
                            <p class="text-[10px] text-slate-400 mt-1.5 ml-1">Controls the permission level within the dashboard.</p>
                        </div>
                    </div>
                </div>
